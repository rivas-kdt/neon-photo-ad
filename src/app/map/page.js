...
const geotaggedPhotos = [
  { id: 1, lat: 40.7128, lng: -74.0060, thumbnail: '/placeholder.webp' },
    ...
    <div className="h-[calc(100vh-6rem)]">
      ...
      <div className="relative w-full h-full bg-gray-200 rounded-lg overflow-hidden">
        ...
        {geotaggedPhotos.map((photo) => (
          <div
            ...
            style={{ left: `${(photo.lng + 180) * 100 / 360}%`, top: `${(90 - photo.lat) * 100 / 180}%` }}
      ...
      {selectedPhoto && (
        <div className="absolute bottom-20 left-1/2 transform -translate-x-1/2 bg-white p-4 rounded-lg shadow-lg">
          <Image
            src={geotaggedPhotos.find(p => p.id === selectedPhoto)?.thumbnail || "/placeholder.webp"}
